...
export default function Language() {
  ...
  useEffect(() => {
    axios.get("http://localhost:3220/skill").then((response) => {
  ...
  const addTechno = (id) => {
    axios.post("http://localhost:3220/user/skill", { id }).then((response) => {
                          ...
                          {techno.map((tech) => (
                            <div class="flex flex-col justify-between overflow-hidden text-left transition-shadow duration-200 bg-white rounded shadow-xl group hover:shadow-2xl">
                              <div class="p-5">
                                ...
                                <p class="mb-2 font-bold">{techno.title}</p>
                                <h2 class="text-lg leading-5 text-gray-900">
                                  {tech.title}
                                </h2>
                                <br />
                                <button
                                  class="btn gap-2"
                                  onClick={() => addTechno(techno.id)}
                                >
